...
const observationSpace ={ 
  ...
  locNums: {
    ...
    s13: 18,s14: 19,s15: 20,s16: 21,s17: 22,s18: 23, s19: 24,s20: 25,s21: 26,s22: 27,s23: 28,s24: 29,
  },
...
class Agent {
  constructor(n_actions = 2, inputShapeA = 8, inputShapeC = 10, alpha = 0.0002, beta = 0.002, gamma = 0.30, tau = 0.005, warmup = 128, RBufferSize = 100000) {                           
...
function envStep(action, currentStep) {
  ...
  let reward = 0;
  let penalty = 0;
  const safeDistance = 110; // 110 is ray length
...
*/
if (zomDist > safeDistance){ reward += survivalBonus; }
